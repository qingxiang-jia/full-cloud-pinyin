...
typedef void (*FnSetPage)(int32_t idx);
/* ↑ CALLBACK TYPES */
...
extern "C" void register_callbacks(
    ...
    FnVoid clear_candidates, FnSetPreedit set_preedit, FnCanPageUp can_page_up,
    FnVoid page_up, FnVoid page_down, FnVoid prev, FnVoid next,
    FnSetPage set_page, FnCommit commit, FnSetPreedit commit_preedit,
    FnVoid commit_candidate_by_fixed_key);
extern "C" bool on_key_press(FcpOpaque *opaque, uint16_t);
/* ↑ C++ -> Rust */
...
extern "C" void prev();
extern "C" void next();
extern "C" void set_page(int32_t idx);
/* ↑ TABLE */
