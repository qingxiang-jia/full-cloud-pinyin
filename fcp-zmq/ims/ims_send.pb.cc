...
static ::_pb::Metadata file_level_metadata_proto_2fims_5fsend_2eproto[1];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_proto_2fims_5fsend_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_proto_2fims_5fsend_2eproto = nullptr;
const ::uint32_t TableStruct_proto_2fims_5fsend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_proto_2fims_5fsend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\024proto/ims_send.proto\"&\n\nFcitxEvent\022\030\n\005"
    "event\030\001 \001(\0162\t.KeyEvent*\351\007\n\010KeyEvent\022\t\n\005N"
...
static ::absl::once_flag descriptor_table_proto_2fims_5fsend_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2fims_5fsend_2eproto = {
    false,
    false,
    1074,
    descriptor_table_protodef_proto_2fims_5fsend_2eproto,
    "proto/ims_send.proto",
    &descriptor_table_proto_2fims_5fsend_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_proto_2fims_5fsend_2eproto::offsets,
    file_level_metadata_proto_2fims_5fsend_2eproto,
    file_level_enum_descriptors_proto_2fims_5fsend_2eproto,
    file_level_service_descriptors_proto_2fims_5fsend_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2fims_5fsend_2eproto_getter() {
  return &descriptor_table_proto_2fims_5fsend_2eproto;
}
// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2fims_5fsend_2eproto(&descriptor_table_proto_2fims_5fsend_2eproto);
const ::google::protobuf::EnumDescriptor* KeyEvent_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_proto_2fims_5fsend_2eproto);
  return file_level_enum_descriptors_proto_2fims_5fsend_2eproto[0];
}
...
::google::protobuf::Metadata FcitxEvent::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2fims_5fsend_2eproto_getter, &descriptor_table_proto_2fims_5fsend_2eproto_once,
      file_level_metadata_proto_2fims_5fsend_2eproto[0]);
}
